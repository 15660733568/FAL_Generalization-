...
def args_parser():
    ...
    # other arguments
    parser.add_argument('--dataset', type=str, default='webspam',
                        help="name of dataset")
    parser.add_argument('--data_path', type=str,
                        default='D:/py-project/Fal_webspam/data/webspam/webspam_wc_normalized_unigram.svm',
                        help="path to dataset file")
    parser.add_argument('--gpu', type=int, default=1, help="Set 1 to use CUDA, 0 for CPU.")
