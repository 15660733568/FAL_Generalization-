...
def args_parser():
    ...
    parser.add_argument('--out-dir',type=str,default='../FAT_result',help='dir of output')
    ...
    parser.add_argument('--modeltype',type=str,default='SmallCNN',help='different model structure')
